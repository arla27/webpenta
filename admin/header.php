...
<head>
	...
	<title>Penta Prima - Admin Panel</title>
  		...
  		<aside class="main-sidebar">
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
			        ...
			        <li class="treeview <?php if( ($cur_page == 'product-category-add.php')||($cur_page == 'product-category.php')||($cur_page == 'product-category-edit.php') || ($cur_page == 'product-add.php')||($cur_page == 'product.php')||($cur_page == 'product-edit.php')|| ($cur_page == 'product-photo-add.php')||($cur_page == 'product-photo.php')||($cur_page == 'product-photo-edit.php') ) {echo 'active';} ?>">
						<a href="#">
							<i class="fa fa-hand-o-right"></i>
						...
						<ul class="treeview-menu">
							<li><a href="product-category.php"><i class="fa fa-circle-o"></i> Product Category</a></li>
							<li><a href="product.php"><i class="fa fa-circle-o"></i> Product</a></li>
							<li><a href="product-photo.php"><i class="fa fa-circle-o"></i> Gallery Product</a></li>
						</ul>
					</li>
					...
					<li class="treeview <?php if( ($cur_page == 'designation-add.php')||($cur_page == 'designation.php')||($cur_page == 'designation-edit.php') || ($cur_page == 'team-member-add.php')||($cur_page == 'team-member.php')||($cur_page == 'team-member-edit.php') ) {echo 'active';} ?>">
						...
						<ul class="treeview-menu">
							<li><a href="designation.php"><i class="fa fa-circle-o"></i> Branch</a></li>
							<li><a href="team-member.php"><i class="fa fa-circle-o"></i> Store</a></li>
						</ul>
					</li>
			        ...
			        <li class="treeview <?php if( ($cur_page == 'partner-add.php')||($cur_page == 'partner.php')||($cur_page == 'partner-edit.php') ) {echo 'active';} ?>">
			          <a href="partner.php">
			            <i class="fa fa-hand-o-right"></i> <span>Promotion Product</span>
			          </a>
			        </li>
