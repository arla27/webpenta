...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
    	...
    	if($path == '') {
			...
			$statement = $pdo->prepare("UPDATE tbl_product SET product_caption=?, p_category_id=? WHERE product_id=?");
			$statement->execute(array($_POST['product_caption'],$_POST['p_category_id'],$_REQUEST['id']));
    	} else {
        	...
        	// updating into the database
			$statement = $pdo->prepare("UPDATE tbl_product SET product_caption=?, photo_name=?, p_category_id=? WHERE product_id=?");
			$statement->execute(array($_POST['product_caption'],$final_name,$_POST['p_category_id'],$_REQUEST['id']));
    	}
...
foreach ($result as $row) {
	$product_caption = $row['product_caption'];
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" name="product_caption" value="<?php echo $product_caption ?>">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Product Category <span>*</span></label>
							<div class="col-sm-4">
