			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
						<label for="" class="col-sm-2 control-label">Copy link: </label>
						<input class="form-copy" id="text-copy" value="http://localhost/webpenta/assets/uploads/<?php echo $file_name; ?>">
